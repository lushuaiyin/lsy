...
public class ChannelRedisRateLimiter extends AbstractRateLimiter<ChannelRedisRateLimiter.Config> implements ApplicationContextAware {
//	@Deprecated
...
//	@Deprecated
	...
	public ChannelRedisRateLimiter(ReactiveRedisTemplate<String, String> redisTemplate,
...
//		log.info("ChannelRedisRateLimiter routeId["+routeId+"],id["+id+"]"+"的初始配置：replenishRate=="+replenishRate+",burstCapacity=="+burstCapacity);
		...
		Map<String , String> rateLimitConfigMap = rateLimiterConfig.getRateLimitChannel();
