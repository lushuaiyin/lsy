...
public class IPRedisRateLimiter extends AbstractRateLimiter<IPRedisRateLimiter.Config> implements ApplicationContextAware {
//	@Deprecated
...
//	@Deprecated
	...
	public static final String CONFIGURATION_PROPERTY_NAME = "ip-redis-rate-limiter";//修改
	...
	public IPRedisRateLimiter(ReactiveRedisTemplate<String, String> redisTemplate,
	...
	public IPRedisRateLimiter(int defaultReplenishRate, int defaultBurstCapacity) {
...
//		log.info("ChannelRedisRateLimiter routeId["+routeId+"],id["+id+"]"+"的初始配置：replenishRate=="+replenishRate+",burstCapacity=="+burstCapacity);
		...
		Map<String , String> rateLimitConfigMap = rateLimiterConfig.getRateLimitIP();
...
//		String prefix = "request_rate_limiter.{" + id;
		String prefix = "request_ip_rate_limiter.{" + id;//修改
