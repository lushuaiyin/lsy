...
public abstract class MessageToMessageEncoder<I> extends ChannelOutboundHandlerAdapter {
	...
	private static final Logger logger = LoggerFactory.getLogger(MessageToMessageEncoder.class);
        ...
        try {
            if (acceptOutboundMessage(msg)) {
                ...
                try {
                	...
                	logger.error("MessageToMessageEncoder==write==ReferenceCountUtil.release"
                			+ "==cast=="+cast.getClass());
                    ReferenceCountUtil.release(cast);
                    logger.error("MessageToMessageEncoder==write==ReferenceCountUtil.release"
                			+ "==cast=="+cast.getClass()+"--finished");
                }
